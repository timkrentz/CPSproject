###########################################################################
## Makefile generated for Simulink model 'getLidar'. 
## 
## Makefile     : getLidar.mk
## Generated on : Tue Apr 18 17:38:48 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/getLidar.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/krentzts/Documents/MATLAB/CPSproject
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = getLidar_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = getLidar_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/getLidar.exe
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/getLidar_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=getLidar -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/getLidar_grt_rtw/getLidar.c $(START_DIR)/getLidar_grt_rtw/rtGetInf.c $(START_DIR)/getLidar_grt_rtw/rtGetNaN.c $(START_DIR)/getLidar_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = getLidar.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/getLidar_grt_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
